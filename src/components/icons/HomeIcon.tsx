...
export const HomeIcon = ({ focused, color, size = 24 }: Props) =>
{
	return (
		<Svg width={size} height={size} viewBox="0 0 512 512">
			<G transform="translate(0,512) scale(0.1,-0.1)" fill={color} stroke="none" >
				{ focused ? (
					<>
						<Path d="M1309 2297 c-222 -178 -409 -330 -416 -338 -25 -31 -20 -83 12 -114
						20 -21 34 -25 85 -25 l60 0 0 -445 0 -446 25 -24 c13 -14 34 -25 47 -26 13 0
						108 0 212 0 252 0 235 -16 239 226 4 197 10 220 67 269 65 54 155 54 220 0 57
						-49 63 -71 66 -268 4 -240 -13 -224 234 -226 250 -2 238 -3 265 25 l25 24 0
						446 0 445 60 0 c51 0 65 4 85 25 32 31 37 83 12 114 -7 8 -194 160 -416 338
						-368 294 -407 323 -441 323 -34 0 -73 -29 -441 -323z"/>
					</>
					) : (
						<>
